...
const ProductCard = ( {product}) => {
    ...
    console.log(cartItems , product , "erkvsnufmk")

  return product && (
    <div onClick={ ()=> {navigate(`/products/${product.category}/${product._id}`) ; scrollTo(0 , 0)}} className='border border-gray-500/20 rounded-md px-3 md:px-4 py-4 bg-white min-w-56 max-w-56 w-full'>
