...
const PageNotFound = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-sm max-md:px-4 py-20">
            ...
            <button onClick={()=>navigate('/')} className="group flex items-center gap-1 bg-white hover:bg-gray-200 px-7 py-2.5 text-gray-800 rounded-full mt-10 font-medium active:scale-95 transition-all">
                Back to Home
